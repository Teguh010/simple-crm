...
import UpdateCliCommonPetHairColorModal from './UpdateCliCommonPetHairColorModal.vue'
...
const openAddModal = async (params = null) => {
  await mtUtils.smallPopup(UpdateCliCommonPetHairColorModal, {
...
const init = async () => {
  ...
  if (response) {
    cliCommonOptionList.value = getCliCommonHairColorList.value.filter(
