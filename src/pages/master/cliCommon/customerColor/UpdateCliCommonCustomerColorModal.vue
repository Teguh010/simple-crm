...
const CODE_CLI_WITH_COLOR_PICKER = [3]
...
const save = async () => {
  ...
  if (isEdit.value) {
    ...
    if (res && res.code == 400) {
      await mtUtils.autoCloseAlert(res.detail)
      return
    }
...
const isError = computed(() => {
  ...
  const isAlreadyTaken = cliCommonStore.getCliCommonCustomerColorList.find(cli => {
    return cli.code_cli_common == 3 && cli.code_func1 == cliCommonForm.code_func1
  })
      ...
      <q-card-section class="row q-col-gutter-md">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
          <MtInputForm
            ...
            :label="formLabels.commentCliLabel"
            type="text"            
            tabindex="2"
          />
        </div>
        ...
        >
          <MtInputColorPicker :label="formLabels.text1CliLabel" tabindex="3" v-model="cliCommonForm.text1" />
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
          <MtInputForm
